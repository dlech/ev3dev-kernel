...
static struct pwm_lookup legoev3_pwm_lookup[] = {
	...
	PWM_LOOKUP("ecap.0",   0, NULL, "ev3:outC",          0, PWM_POLARITY_NORMAL),
	PWM_LOOKUP("ecap.1",   0, NULL, "ev3:outD",          0, PWM_POLARITY_NORMAL),
	...
	PWM_LOOKUP("ehrpwm.1", 0, NULL, "ev3:outB",          0, PWM_POLARITY_NORMAL),
	PWM_LOOKUP("ehrpwm.1", 1, NULL, "ev3:outA",          0, PWM_POLARITY_NORMAL),
};
