...
static __init void dm365_clk_init(void)
{
	...
	clk = PSC_CLK("vpss_dac", "pll1_sysclk3", psc, DM365_LPSC_DAC_CLK, 0, 0);
	...
	clk = PSC_CLK("uart1", "pll1_sysclk4", psc, DAVINCI_LPSC_UART1, 0, 0);
	clk_register_clkdev(clk, NULL, "serial8250.1");
	clk = PSC_CLK("i2c", "pll1_aux_clk", psc, DAVINCI_LPSC_I2C, 0, 0);
	clk_register_clkdev(clk, NULL, "i2c_davinci.1");
	clk = PSC_CLK("mmcsd0", "pll1_sysclk8", psc, DAVINCI_LPSC_MMC_SD, 0, 0);
	clk_register_clkdev(clk, NULL, "da830-mmc.0");
	clk = PSC_CLK("mmcsd1", "pll1_sysclk4", psc, DM365_LPSC_MMC_SD1, 0, 0);
	clk_register_clkdev(clk, NULL, "da830-mmc.1");
	clk = PSC_CLK("spi0", "pll1_sysclk4", psc, DAVINCI_LPSC_SPI, 0, 0);
	clk_register_clkdev(clk, NULL, "spi_davinci.0");
	clk = PSC_CLK("spi1", "pll1_sysclk4", psc, DM365_LPSC_SPI1, 0, 0);
	clk_register_clkdev(clk, NULL, "spi_davinci.1");
	clk = PSC_CLK("spi2", "pll1_sysclk4", psc, DM365_LPSC_SPI2, 0, 0);
	clk_register_clkdev(clk, NULL, "spi_davinci.2");
	clk = PSC_CLK("spi3", "pll1_sysclk4", psc, DM365_LPSC_SPI3, 0, 0);
	clk_register_clkdev(clk, NULL, "spi_davinci.3");
	clk = PSC_CLK("spi4", "pll1_aux_clk", psc, DM365_LPSC_SPI4, 0, 0);
	clk_register_clkdev(clk, NULL, "spi_davinci.4");
	clk = PSC_CLK("gpio", "pll1_sysclk4", psc, DAVINCI_LPSC_GPIO, 0, 0);
	clk_register_clkdev(clk, "gpio", NULL);
	clk = PSC_CLK("aemif", "pll1_sysclk4", psc, DAVINCI_LPSC_AEMIF, 0, 0);
	...
	clk = PSC_CLK("pwm3", "ref_clk", psc, DM365_LPSC_PWM3, 0, 0);
	...
	clk = PSC_CLK("timer2", "pll1_aux_clk", psc, DAVINCI_LPSC_TIMER2, 0, 0);
	clk_prepare_enable(clk);
	clk_register_clkdev(clk, NULL, "davinci-wdt");
	clk = PSC_CLK("timer3", "pll1_aux_clk", psc, DM365_LPSC_TIMER3, 0, 0);
	clk_register_clkdev(clk, "timer3", NULL);
	clk = PSC_CLK("usb", "pll1_aux_clk", psc, DAVINCI_LPSC_USB, 0, 0);
	clk_register_clkdev(clk, "usb", NULL);
	clk = PSC_CLK("emac", "pll1_sysclk4", psc, DM365_LPSC_EMAC, 0, 0);
	clk_register_clkdev(clk, NULL, "davinci_emac.1");
	clk_register_clkdev(clk, "fck", "davinci_mdio.0");
	clk = PSC_CLK("voice_codec", "pll2_sysclk4", psc, DM365_LPSC_VOICE_CODEC,
		      0, 0);
	clk_register_clkdev(clk, NULL, "davinci_voicecodec");
	clk = PSC_CLK("asp0", "pll1_sysclk4", psc, DM365_LPSC_McBSP1, 0, 0);
	clk_register_clkdev(clk, NULL, "davinci-mcbsp");
	clk = PSC_CLK("rto", "pll1_sysclk4", psc, DM365_LPSC_RTO, 0, 0);
	clk_register_clkdev(clk, "rto", NULL);
	clk = PSC_CLK("mjcp", "pll1_sysclk3", psc, DM365_LPSC_MJCP, 0, 0);
