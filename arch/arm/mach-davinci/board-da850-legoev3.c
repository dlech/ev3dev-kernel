...
#define EV3_USB11_VBUS_OVC	DA850_GPIO6_3
#define EV3_USB11_VBUS_OVC_PIN	GPIO_TO_PIN(6, 3)
#define EV3_USB11_VBUS_ENA	DA850_GPIO6_5
#define EV3_USB11_VBUS_ENA_PIN	GPIO_TO_PIN(6, 5)

static const short legoev3_usb11_pins[] __initconst = {
	EV3_USB11_VBUS_OVC, EV3_USB11_VBUS_ENA,
	-1
};

static struct regulator_consumer_supply legoev3_usb_regulator_consumer =
	REGULATOR_SUPPLY("vbus", "ohci.0");

static struct regulator_init_data legoev3_usb_regulator_init_data = {
	.constraints = {
		.valid_ops_mask	= REGULATOR_CHANGE_STATUS,
	},
	.consumer_supplies	= &legoev3_usb_regulator_consumer,
	.num_consumer_supplies	= 1,
};

static struct fixed_voltage_config legoev3_usb_regulator_pdata = {
	.supply_name	= "vbus",
	.microvolts	= 5000000, /* 5V */
	.gpio		= EV3_USB11_VBUS_ENA_PIN,
	.startup_delay	= 3000, /* 3ms */
	.enable_high	= 1,
	.init_data	= &legoev3_usb_regulator_init_data,
};

static struct platform_device legoev3_usb_regulator = {
	.name = "reg-fixed-voltage",
	.id = 0,
	.dev = {
		.platform_data = &legoev3_usb_regulator_pdata,
	},
};
...
static __init void legoev3_usb_init(void)
{
	...
	// ret = platform_device_register(&legoev3_usb_regulator);
	// if (ret)
...
static struct of_dev_auxdata legoev3_auxdata_lookup[] __initdata = {
...
#else
#define legoev3_auxdata_lookup NULL
#endif
 ...
 */
static __init void legoev3_init_machine(void)
{
	int ret;
	// bool stock_lcd;
	// u8 ehrpwm_mask = 0;
	...
	// if (ret)
	// 	pr_warn("legoev3_evm_init: watchdog registration failed: %d\n",
	// 			ret);
	...
	of_platform_default_populate(NULL, legoev3_auxdata_lookup, NULL);
}

static const char *const legoev3_boards_compat[] __initconst = {
	"lego,ev3",
	NULL,
};

DT_MACHINE_START(LEGOEV3_DT, "LEGO MINDSTORMS EV3")
	.map_io		= da850_init,
	.init_machine	= legoev3_init_machine,
	.dt_compat	= legoev3_boards_compat,
