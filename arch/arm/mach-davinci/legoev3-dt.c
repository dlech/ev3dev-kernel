...
static struct i2c_legoev3_platform_data legoev3_i2c2_data = {
	.sda_pin	= EV3_IN1_PIN5_PIN,
	.scl_pin	= EV3_IN1_I2C_CLK_PIN,
	.port_id	= EV3_PORT_IN1,
};

static struct platform_device legoev3_i2c2_device = {
	.name	= "i2c-legoev3",
	.dev	= {
		.platform_data	= &legoev3_i2c2_data,
	},
	.id	= 2,
};
...
static void __init legoev3_init_machine(void)
{
	...
	ret = platform_device_register(&legoev3_i2c2_device);
	if (ret)
